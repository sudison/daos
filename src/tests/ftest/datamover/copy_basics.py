...
class CopyBasicsTest(DataMoverTestBase):
    ...
    def test_copy_types_dcp(self):
        ...
        :avocado: tags=copy_basics,copy_types,copy_types_dcp
        """
        self._copy_types("DCP")

    def test_copy_types_fs_copy(self):
        """
        Test Description:
            Tests POSIX copy with difference source and destination types.
            Uses the daos filesystem tool.
        :avocado: tags=all,pr,datamover,daos_fs_copy
        :avocado: tags=copy_basics,copy_types,copy_types_fs_copy
        """
        self._copy_types("FS_COPY")
    ...
    def _copy_types(self, tool):
        ...
        for (test_desc, src, dst) in copy_list:
            ...
            self.set_params(
                ...
                src_pool=src_pool, src_cont=src_cont,
                dst_type=dst_type, dst_path=dst_path,
                dst_pool=dst_pool, dst_cont=dst_cont)
            ...
            dst[1] = join(dst[1], basename(src[1]))
    ...
    def test_copy_subsets_dcp(self):
        ...
        :avocado: tags=all,pr,datamover,dcp
        :avocado: tags=copy_basics,copy_subsets,copy_subsets_dcp
        """
        self._copy_subsets("DCP")

    def test_copy_subsets_fs_copy(self):
        """
        Test Description:
            Tests copying POSIX container subsets.
            Uses the daos filesystem copy tool.
        :avocado: tags=all,pr,datamover,daos_fs_copy
        :avocado: tags=copy_basics,copy_subsets,copy_subsets_fs_copy
        """
        self._copy_subsets("FS_COPY")
