...
class OverwriteContainerACLTest(ContSecurityTestBase):
    ...
    def test_acl_overwrite_invalid_inputs(self):
        ...
        :avocado: tags=all,pr,daily_regression,security,container_acl,cont_overwrite_acl_inputs
        """
    ...
    def test_overwrite_invalid_acl_file(self):
        ...
        :avocado: tags=all,pr,daily_regression,security,container_acl,cont_overwrite_acl_file
        """
    ...
    def test_no_user_permissions(self):
        ...
        :avocado: tags=all,pr,daily_regression,security,container_acl,cont_overwrite_acl_noperms
        """
