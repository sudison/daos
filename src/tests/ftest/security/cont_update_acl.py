...
class UpdateContainerACLTest(ContSecurityTestBase):
    ...
    def test_acl_update_invalid_inputs(self):
        ...
        :avocado: tags=all,branch_timer,security,container_acl,cont_update_acl_inputs
        """
    ...
    def test_update_invalid_acl(self):
        ...
        :avocado: tags=all,branch_timer,security,container_acl,cont_update_invalid_acl
        """
    ...
    def test_update_acl_file(self):
        ...
        :avocado: tags=all,branch_timer,security,container_acl,cont_update_acl
        """
        path_to_file = os.path.join(self.tmp, self.acl_filename)
    ...
    def test_no_user_permissions(self):
        ...
        :avocado: tags=all,branch_timer,security,container_acl,cont_update_acl_noperms
        """
