...
class DeleteContainerACLTest(ContSecurityTestBase):
    ...
    def test_acl_delete_invalid_inputs(self):
        ...
        :avocado: tags=all,master_branch,security,container_acl,cont_delete_acl_inputs
        """
    ...
    def test_delete_valid_acl(self):
        ...
        :avocado: tags=all,master_branch,security,container_acl,cont_delete_acl
        """
    ...
    def test_no_user_permissions(self):
        ...
        :avocado: tags=all,master_branch,security,container_acl,cont_delete_acl_noperms
        """
