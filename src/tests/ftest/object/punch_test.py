...
class PunchTest(TestWithServers):
    ...
    def test_dkey_punch(self):
        ...
        :avocado: tags=all,object,pr,daily_regression,small,dkeypunch
        """
    ...
    def test_akey_punch(self):
        ...
        :avocado: tags=all,object,pr,daily_regression,small,akeypunch
        """
    ...
    def test_obj_punch(self):
        ...
        :avocado: tags=all,object,pr,daily_regression,small,objpunch
        """
