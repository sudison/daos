...
class DaosServerTest(TestWithServers):
    ...
    def test_daos_server_reformat(self):
        ...
        :avocado: tags=all,master_branch,hw,large,server_test,server_reformat,DAOS_5610
        """
    ...
    def test_daos_io_server_restart(self):
        ...
        :avocado: tags=all,master_branch,hw,large,server_test,server_restart,DAOS_5610
        """
