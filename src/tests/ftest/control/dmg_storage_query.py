...
class DmgStorageQuery(ControlTestBase):
    ...
    def test_dmg_storage_query_devices(self):
        ...
        :avocado: tags=all,branch_timer,hw,small,storage_query_devs,basic,dmg
        """
    ...
    def test_dmg_storage_query_pools(self):
        ...
        :avocado: tags=all,branch_timer,hw,small,storage_query_pools,basic,dmg
        """
    ...
    def test_dmg_storage_query_device_health(self):
        ...
        :avocado: tags=all,branch_timer,hw,small,storage_query_health,basic
        """
    ...
    def test_dmg_storage_query_device_state(self):
        ...
        :avocado: tags=all,branch_timer,hw,small,storage_query_faulty,basic
        """
